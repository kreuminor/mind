package jm.mind.mobile.calender;
...
public class AnnounceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Calender Events");
    ...
    private class AnnounceScrape extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                announce = Jsoup.connect("http://drive.google.com/uc?export=downloads&id=0B1VzuZrVMPLNdUJwTXlSZUFaTWs").get();
