    ...
    private class myWebClient extends WebViewClient {
        ...
        public void onReceivedError(WebView view, int errorCode,
            ...
            if (errorCode == -2) {
                ...
                builder.setMessage(Html.fromHtml("<font color='#120049'>The YouTube Feed will not open, your data services are not working. Please check your data services.</font>"));
