package jm.mind.mobile.evaluation;
...
public class Registration extends AppCompatActivity {
    ...
    public static final String FEEDBACK_TEN_STARS_ROW_ID = "9082377273";
    public static final String FEEDBACK_POSITIVE_ROW_ID_2 = "9082377274";
    public static final String SAMPLE_APP = "Conference 2017";
    public static final String SURVEY_HASH = "CQ3ZHW8";
...
*/
                ...
                for (int i = 0; i < responsesList.length(); i++) {
                    ...
                    if (response.getString(QUESTION_ID).equals(FEEDBACK_QUESTION_ID)) {
                        ...
                        for (int j = 0; j < answers.length(); j++) {
                            ...
                            if (currentAnswer.getString(ROW_ID).equals(FEEDBACK_TEN_STARS_ROW_ID) || currentAnswer.getString(ROW_ID).equals(FEEDBACK_POSITIVE_ROW_ID_2)) {
                                isPromoter = true;
                                break;
                            }
                        }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Registration.this, ConferenceMain.class);
        startActivity(intent);
