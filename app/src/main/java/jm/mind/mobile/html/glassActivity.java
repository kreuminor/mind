...
public class glassActivity extends Activity implements AdvancedWebView.Listener {

	private static final String TEST_PAGE_URL = "http://www.broadbentja.com/";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mWebView.loadUrl("http://www.broadbentja.com/");
	...
	public void onPageError(int errorCode, String description, String failingUrl) {
		if (errorCode == -2) {
			...
			builder.setMessage(Html.fromHtml("<font color='#120049'>The Broadbent Glasses Page will not open, your data services are not working. Please check your data services.</font>"));
