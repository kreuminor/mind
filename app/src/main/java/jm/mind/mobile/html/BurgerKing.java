...
public class BurgerKing extends AppCompatActivity implements AdvancedWebView.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebView.loadUrl("https://www.bk.com/menu");
    ...
    public void onPageError(int errorCode, String description, String failingUrl) {
        if (errorCode == -2) {
            ...
            builder.setMessage(Html.fromHtml("<font color='#120049'>The Burger King Page will not open, your data services are not working. Please check your data services.</font>"));
