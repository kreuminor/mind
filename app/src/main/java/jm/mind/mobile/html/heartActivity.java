...
public class heartActivity extends Activity implements AdvancedWebView.Listener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mWebView.loadUrl("http://www.heart-nta.org/");
	...
	public void onPageError(int errorCode, String description, String failingUrl) {
		if (errorCode == -2) {
			...
			builder.setMessage(Html.fromHtml("<font color='#120049'>The HEART Trust Page will not open, your data services are not working. Please check your data services.</font>"));
