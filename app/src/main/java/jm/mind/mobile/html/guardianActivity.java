...
public class guardianActivity extends Activity implements AdvancedWebView.Listener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mWebView.loadUrl("http://jamaica.myguardiangroup.com/guardian-life-limited");
	...
	public void onPageError(int errorCode, String description, String failingUrl) {
		if (errorCode == -2) {
			...
			builder.setMessage(Html.fromHtml("<font color='#120049'>The Tyre Warehouse Page will not open, your data services are not working. Please check your data services.</font>"));
