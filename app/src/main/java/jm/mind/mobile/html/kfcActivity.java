...
public class kfcActivity extends Activity implements AdvancedWebView.Listener {

	private static final String TEST_PAGE_URL = "https://www.kfc.com/menu/promotions";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mWebView.loadUrl("https://www.kfc.com/menu/promotions");
	...
	public void onPageError(int errorCode, String description, String failingUrl) {
		if (errorCode == -2) {
			...
			builder.setMessage(Html.fromHtml("<font color='#120049'>The KFC Page will not open, your data services are not working. Please check your data services.</font>"));
